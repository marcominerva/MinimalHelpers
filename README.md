...
A library that provides Routing helpers for Minimal API projects for automatic endpoints registration.
...
> **Note**
The `MapEndpoints` is generated by the Source Generator.
...
> **Note**
This workaround is no longer necessary in .NET 8.0, since it correctly sets in the **format** attribute in **swagger.json** for these data types.
